export default {
  "gleam/bit_array": `import gleam/int
import gleam/order
import gleam/string
...
pub fn starts_with(bits: BitArray, prefix: BitArray) -> Bool {
  ...
  "gleam/bool": `pub fn and(a: Bool, b: Bool) -> Bool {
  a && b
}
...
pub fn lazy_guard(
  ...
  "gleam/bytes_tree": `import gleam/bit_array
import gleam/list
...
fn cast(a: anything) -> Dynamic`,
  "gleam/dynamic/decode": `import gleam/bit_array
...
pub fn each(set: Set(member), fun: fn(member) -> a) -> Nil {
  ...
  "gleam/string": `import gleam/list
import gleam/option.{type Option, None, Some}
import gleam/order
import gleam/string_tree.{type StringTree}
