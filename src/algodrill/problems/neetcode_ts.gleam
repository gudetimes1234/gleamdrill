  ...
  Category("NeetCode 150 (TypeScript)", [
    Subcategory("Arrays & Hashing", [
      ...
      drill(
        ...
        embedded_ts.nc02_valid_anagram(),
      ),
      drill(
        "Two Sum",
      ...
      drill(
        ...
        embedded_ts.nc04_group_anagrams(),
      ),
      drill(
        "Top K Frequent Elements",
        "Given an integer array nums and an integer k, return the k most frequent elements. You may return the answer in any order.",
        embedded_ts.nc05_top_k_frequent(),
      ),
      drill(
        ...
        embedded_ts.nc06_product_except_self(),
      ),
      drill(
        "Longest Consecutive Sequence",
        "Given an unsorted array of integers nums, return the length of the longest consecutive elements sequence. You must write an algorithm that runs in O(n) time.",
        embedded_ts.nc07_longest_consecutive(),
      ),
    ]),
    Subcategory("Two Pointers", [
      ...
      drill(
        ...
        embedded_ts.nc09_two_sum_sorted(),
      ),
      drill(
        "3Sum",
      ...
      drill(
        ...
        embedded_ts.nc11_container_water(),
      ),
    ]),
    Subcategory("Sliding Window", [
      ...
      drill(
        ...
        embedded_ts.nc13_longest_substring(),
      ),
      drill(
        ...
        embedded_ts.nc14_character_replacement(),
      ),
      drill(
        ...
        embedded_ts.nc15_permutation_in_string(),
      ),
    ]),
    Subcategory("Stack", [
      drill(
      ...
      drill(
        ...
        embedded_ts.nc18_daily_temperatures(),
      ),
    ]),
    Subcategory("Binary Search", [
      ...
      drill(
        ...
        embedded_ts.nc20_find_min_rotated(),
      ),
      drill(
        ...
        embedded_ts.nc21_search_rotated(),
      ),
    ]),
  ])
}
