...
import json as __gleamdrill_json__
from browser import self as __gleamdrill_self__
__gleamdrill_self__.__gleamdrill_result__ = __gleamdrill_json__.dumps(__results__)
"
...
/// the error messages.
const capture_prologue = "import sys as __gleamdrill_sys__
from browser import self as __gleamdrill_self__


class __GleamdrillOut__:
    def write(self, text):
        __gleamdrill_self__.__gleamdrill_write__(text)

    def flush(self):
        pass


__gleamdrill_sys__.stdout = __GleamdrillOut__()
